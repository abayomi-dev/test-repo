...
VERVEBACKUP		verveValidation;				// For verve validation
STISO8583		glRecvPack;						// transaction receiving package 
ECRISO			ecrModeData;					// Ecr Mode Data Struct
PROFILETAG		profileTag;						// Profile Tag
PRINTVAS		printVas;						// Print Vas Tag
...
{
	{"NGN", "\x05\x66", "\x05\x66", 2, 0}, // 1.Nigerian Naira
...
//GUI_TEXT_ATTR gl_stTitleAttr = {GUI_FONT_SMALL, GUI_ALIGN_CENTER, GUI_FONT_REVERSAL};
//GUI_TEXT_ATTR gl_stLeftAttr = {GUI_FONT_SMALL, GUI_ALIGN_LEFT, GUI_FONT_STD};
//GUI_TEXT_ATTR gl_stCenterAttr = {GUI_FONT_SMALL, GUI_ALIGN_CENTER, GUI_FONT_STD};
//GUI_TEXT_ATTR gl_stRightAttr = {GUI_FONT_SMALL, GUI_ALIGN_RIGHT, GUI_FONT_STD};
