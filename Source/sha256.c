...
/* $Id: sha256.c 501 2011-09-25 17:12:27Z xchatty $ */
...
{
  sha256_update((context_sha256_t *)ctx,buf,(uint32_ts) len);
}
...
void sha256_process( context_sha256_t *ctx, const uint8_ts data[64] );
void sha256_process( context_sha256_t *ctx, const uint8_ts data[64] )
{
  uint32_ts temp1, temp2, W[64];
  uint32_ts A, B, C, D, E, F, G, H;
...
static uint8_ts sha256_padding[64] =
  {
